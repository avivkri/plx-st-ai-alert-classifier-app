...
def plot_metrics(true_labels, predicted_labels, predicted_scores):
    ...
    bars1 = ax.bar(r1, df['Weighted'], width=bar_width, label='Weighted', color='#CCD4BF')
    bars2 = ax.bar(r2, df['Micro'], width=bar_width, label='Micro', color='#E7CBA9')
    bars3 = ax.bar(r3, df['Macro'], width=bar_width, label='Macro', color='#EEBAB2')

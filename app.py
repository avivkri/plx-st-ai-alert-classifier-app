...
def main():
    ...
    # Input text area
    input_data = st.text_area("Enter Input Data", default_value="\"inputs\": \"[pr-cp-reg-12345 - kube-system] - CPUThrottlingHigh -  throttling of CPU in namespace kube-system for container aws-vpc-cni-init in pod aris-kube-prometheus-stack-kube-state-metrics-785d575975-s2j2k.\"")
